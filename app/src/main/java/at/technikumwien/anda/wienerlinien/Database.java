...
public class Database {
    ...
    public List<Line> getLines() {
        if (lines == null) {
            ...
            final Line u1 = new Line("U1", Color.parseColor("#E20A16"), u1Stations);

            // Create lines u2, u3 and u4 without stations
            final Line u2 = new Line("U2", Color.parseColor("#764785"), null);
            final Line u3 = new Line("U3", Color.parseColor("#F76013"), null);
            final Line u4 = new Line("U4", Color.parseColor("#008131"), null);
            ...
            final Line u6 = new Line("U6", Color.parseColor("#88471F"), u6Stations);

            // Create line 31
            final Line tram31 = new Line("31", Color.parseColor("#999999"), null);
